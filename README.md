 hey dudes i use to see afew points Coding this Service here to tell you about when coding this :
...
- how do you want to fix race condition , i did here using transactional db management how ,i have 2 queries that write on db ,one update ,one insert 
